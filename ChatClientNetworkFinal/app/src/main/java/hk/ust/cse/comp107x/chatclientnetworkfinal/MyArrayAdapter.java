...
public class MyArrayAdapter extends ArrayAdapter<Contacts.FriendInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Picasso.with(context).load("http://192.168.1.10:3000/"+friendInfoList.get(position).imageURL).into(imageView);
//        Picasso.with(context)
//                .load("http://192.168.1.10:3000/"+friendInfoList.get(position).imageURL)
//                .resize(5, 5)
//                .centerCrop()
//                .into(imageView);
        Picasso.with(context)
